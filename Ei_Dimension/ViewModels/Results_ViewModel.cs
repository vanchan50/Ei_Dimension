...
{
  [POCOViewModel]
  public class Results_ViewModel
  {
    ...
    public static Results_ViewModel Instance { get; private set; }

    protected Results_ViewModel()
    {
      GetAvailableResults();
    ...
    public static Results_ViewModel Create()
    {
      return ViewModelSource.Create(() => new Results_ViewModel());
    }
